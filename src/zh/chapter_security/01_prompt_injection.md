...
> 📖 **想深入了解 Prompt 注入攻防的学术前沿？** 请阅读 [19.6 论文解读：安全与可靠性前沿研究](./06_paper_readings.md)，涵盖间接注入、HackAPrompt、StruQ/SecAlign、Spotlighting 等核心论文的深度解读。
>
...
[19.2 幻觉问题与事实性保障](./02_hallucination.md)
