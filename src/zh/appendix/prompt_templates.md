...
| 2.2 | 代码审查 | 审查代码质量和安全性 | 第15章 |
| 2.3 | 数据分析 | 从数据中提取洞察 | 第21章 |
| **3. Few-shot 示例** | 少样本学习任务 | 第2章 |
| **4. 结构化输出** | | | |
| 4.1 | JSON 格式输出 | 需要结构化 JSON 返回 | 第8章 |
| 4.2 | Markdown 报告输出 | 生成格式化报告 | 第21章 |
| **5. 安全防护提示词** | Prompt 注入防御 | 第19章 |
| **6. Multi-Agent 协调** | | | |
| 6.1 | 任务分配（Orchestrator） | 多 Agent 任务编排 | 第16章 |
| 6.2 | 专家 Agent（Worker） | 专家角色定义 | 第16章 |
| 6.3 | Agent 间消息传递 | Agent 协作通信 | 第17章 |
| **7. RAG 增强** | | | |
...
| 10.2 | 有害内容过滤 | 安全内容审核 | 第19章 |
| 10.3 | 幻觉检测 | 检测 AI 编造的信息 | 第19章 |
| **11. 领域特化** | | | |
| 11.1 | 金融分析 | 财务数据分析 | 第21章 |
| 11.2 | 教育辅导 | 教学引导 | — |
| 11.3 | 医疗健康咨询 | 健康信息科普 | — |
| **12. 多轮对话管理** | | | |
